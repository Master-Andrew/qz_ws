...
int main(int argc, char **argv)
{
  ...
  showPointcloud(pc_pcl_init_merge, init_merge_pcl_file);
  ...
  showPointcloud(pc_pcl_2_aligen, aligen_pcl_file);
  ...
  showPointcloud(pc_pcl_aligen_merge, aligen_merge_pcl_file);
