...
def decode_lines(result, lines, index):
  while index < len(lines):
    ...
    # if key == "ignored_scan_azimuth_ranges_in_degree":
      # print(key, value)
      # if "ignored_scan_azimuth_ranges_in_degree" in result:
        # print(result["ignored_scan_azimuth_ranges_in_degree"])
    if key in result:
...
def decodeExtrinsic(sn, device):
  intrinsic_file = "{}{}/installation/{}.pb.txt".format(param_path, device, sn)
  return decodePbTxt(intrinsic_file)
